...
public class DavidGriffin_PCPartBuilderDataTypes {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Your selected item quantity: " + quantityOfItem);
        ...
        // Additionally, I learned how to get user input using the Scanner class in Java and assigning that user input to a variable to then use in logic.
        ...
        // It is essentially transformationso of data - Input > Process > Output. In this program it is - user input from Scanner > various logic > outputting user data based on various logic.
